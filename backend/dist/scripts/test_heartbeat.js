...
function testHeartbeat() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let res = yield axios_1.default.post(`${BASE_URL}/users/register`, {
            ...
            // 2. Add a Nominee
            res = yield axios_1.default.post(`${BASE_URL}/nominees`, {
                user_id: userId,
                name: 'Wife Nominee',
            ...
            res = yield axios_1.default.post(`${BASE_URL}/admin/trigger_heartbeat_check`, {}, {
                headers: {
