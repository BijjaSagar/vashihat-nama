                  ...
                  child: Column(
                    children: [
                       const Align(
                        ...
                        child: Text("Subscription & Billing", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      ),
                      const SizedBox(height: 16),
                      ListTile(
                        ...
                        subtitle: const Text("Free Tier (1 GB)"),
                        trailing: const Icon(Icons.arrow_forward_ios, size: 14),
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (context) => SubscriptionScreen(userId: widget.userProfile!['id'])),
                          );
                        },
                      ),
                      const Divider(),
                      ListTile(
                        ...
                        title: const Text("Increase Storage"),
                        trailing: const Icon(Icons.arrow_forward_ios, size: 14),
                        onTap: () {
                           Navigator.push(
                            context,
